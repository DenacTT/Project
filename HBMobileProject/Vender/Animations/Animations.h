...
+(void) moveNewUp: (UIView *)view andAnimationDuration: (float) duration andWait:(BOOL) wait andLength:(float) length andFinished:(void (^)())finish;



/**
 *  @author 15-02-05 21:02:36
 *
 *  晃动view
 *
 *  @param view 使用对象
