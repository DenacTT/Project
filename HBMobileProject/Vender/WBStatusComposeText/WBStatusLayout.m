...
- (void)_layoutSource {
    ...
    if (_status.source.length) {
        ...
        if (href.length && text.length) {
            ...
            [from appendString:[NSString stringWithFormat:STR(@"WBFL_comeFrom"), text]];
...
- (void)_layoutToolbar {
    ...
    NSMutableAttributedString *repostText = [[NSMutableAttributedString alloc] initWithString:_status.repostsCount <= 0 ? STR(@"WBFL_transpond") : [WBStatusHelper shortedNumberDesc:_status.repostsCount]];
    ...
    NSMutableAttributedString *commentText = [[NSMutableAttributedString alloc] initWithString:_status.commentsCount <= 0 ? STR(@"WBFL_comment") : [WBStatusHelper shortedNumberDesc:_status.commentsCount]];
    ...
    NSMutableAttributedString *likeText = [[NSMutableAttributedString alloc] initWithString:_status.attitudesCount <= 0 ? STR(@"WBFL_zan") : [WBStatusHelper shortedNumberDesc:_status.attitudesCount]];
    likeText.font = font;
