...
//CZA
typedef void(^ModelTextAction)(UIView *containerView, NSAttributedString *text, NSRange range, CGRect rect, id model);
...
@property (nullable,nonatomic, copy) ModelTextAction modelTapAction;
